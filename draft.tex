...
\begin{figure}
	...
	%$10^{11} M_{\sun}$ to $10^{13.5} M_{\sun}$, 
	...
	%The red line represents the best-fit line for the joint likelihood analysis, drawn using the parameters shown in Table~\ref{tab:param}.
...
%We thank Raul Angulo for helpful information about the Millennium-XXL catalogue snapshots, and Edo van Uitert for making the real data points available to us and for useful discussion about the correct mass units of measurement to use. BJ acknowledges support by an STFC Ernest Rutherford Fellowship, grant reference ST/J004421/1.
